...
def plot_one_timestep(t, color, ax):
	...
	ax.plot(np.linspace(15+2.5+offset, 15+2.5+85+offset, num=18), results, "o", color=color)
...
plot_one_timestep(750, "green", ax)
plot_one_timestep(1000, "yellow", ax)
#plot_one_timestep(1500, "blue", ax)
#plot_one_timestep(2000, "cyan", ax)
plt.savefig("testclangformat.png", format="png")
plt.show()
